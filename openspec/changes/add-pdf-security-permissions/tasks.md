...
- [ ] 6.1 Añadir pruebas unitarias de valores por defecto, compilación invertida de restricciones, contraseñas fijas, límites, relaciones entre capacidades y mensajes de capacidades no independientes; verificar cobertura de las diez opciones.
