...
- [x] 6.5 Realizar una verificación manual en navegador con un PDF de una página, varias páginas, texto en el límite, texto malicioso literal, tamaño final exacto, URL visible y clicable, y un caso que active el warning; verificar que el PDF se abra en un lector común y que la interfaz no reporte éxito falso.
