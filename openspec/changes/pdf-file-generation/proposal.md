...
- Ordenar el formulario para preguntar primero el modo de generación y mostrar inmediatamente después el control de páginas o tamaño final activo, antes del texto de prueba.
